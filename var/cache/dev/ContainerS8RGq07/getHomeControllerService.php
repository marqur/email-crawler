...
return $this->services['App\\Controller\\HomeController'] = new \App\Controller\HomeController(($this->privates['App\\Service\\LoggerService'] ?? $this->load('getLoggerServiceService.php')));
