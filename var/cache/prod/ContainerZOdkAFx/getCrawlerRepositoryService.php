...
// Returns the private 'App\Repository\CrawlerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CrawlerRepository.php';

return $this->privates['App\\Repository\\CrawlerRepository'] = new \App\Repository\CrawlerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
