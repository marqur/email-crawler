...
return $this->services['App\\Controller\\BaseController'] = new \App\Controller\BaseController(($this->privates['App\\Service\\LoggerService'] ?? $this->load('getLoggerServiceService.php')));
